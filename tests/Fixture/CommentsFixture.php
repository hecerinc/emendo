...
class CommentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'comments_ibfk_2' => ['type' => 'foreign', 'columns' => ['issue_id'], 'references' => ['issues', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2016-02-20 20:44:07',
            'modified' => '2016-02-20 20:44:07',
            'user_id' => 1,
            'issue_id' => 1
        ],
    ];
